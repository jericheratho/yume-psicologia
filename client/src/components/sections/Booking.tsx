/* ============================================================
   ...
   Style: Clean, minimal booking interface with Setmore calendar
   ============================================================ */
...
export default function Booking() {
  ...
  return (
    <section id="agendamento" className="py-24 md:py-32 bg-white">
      <div className="container">
        ...
        <div ref={headingRef} className="fade-up mb-16 md:mb-20 text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light text-[#2C2A26] max-w-3xl leading-tight mx-auto">
            Escolha o melhor horário para você
          </h2>
          <p className="font-body text-base md:text-lg font-light text-[#4A4640] mt-6 max-w-2xl mx-auto">
        ...
        <div ref={contentRef} className="fade-up">
          <div className="max-w-4xl mx-auto bg-[#F9F8F6] rounded-2xl overflow-hidden shadow-lg p-8 md:p-12">
            {/* Setmore Iframe */}
            <iframe
        ...
        <div className="mt-16 md:mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-[#8FBF8F]/10 rounded-full mb-4">
              <svg className="w-6 h-6 text-[#8FBF8F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="font-display text-lg font-light text-[#2C2A26] mb-2">
              Por email
            </h3>
            <p className="font-body text-sm font-light text-[#4A4640]">
              <a href="mailto:yumepsicologia@gmail.com" className="text-[#8FBF8F] hover:underline">
          ...
          <div className="text-center p-6">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-[#8FBF8F]/10 rounded-full mb-4">
              <svg className="w-6 h-6 text-[#8FBF8F]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="font-body text-sm font-light text-[#4A4640]">
              <a href="https://wa.me/message/YJ74EWIKNVCGA1" target="_blank" rel="noopener noreferrer" className="text-[#8FBF8F] hover:underline">
                Envie uma mensagem
              </a>
            </p>
          </div>
